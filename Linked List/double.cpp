...
#include <stdlib.h>
using namespace std;
//inisalisasi struct simpul menjadi NDOE
typedef struct simpul NODE;
//deklarasi struct simpul
struct simpul
{
    string nama;
    int nrp;
...
//deklarsi func inisiate
void inisiate()
{
    head = NULL;
    tail = NULL;
}
//deklarsi func isEmpty
bool isEmpty()
{
...
//deklarsi func addFrist untuk menambah data pertama
void addFirst(string nama, int nrp)
{
...
//deklarsi func addLast untuk menambah data terakhir
void addLast(string nama, int nrp)
{
    NODE *data = alokasi_simpul(nama, nrp);
    if (isEmpty())
